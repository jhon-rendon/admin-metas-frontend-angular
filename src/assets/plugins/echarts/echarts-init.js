...
var gaugeChart4 = echarts.init(document.getElementById('gauge-chart'),'');
    ...
    series : [
        {
            ...
            data:[{value: 50, name: 'Cumplimiento'}],
            axisLine: {            // 坐标轴线
...
timeTicket = setInterval(function (){
    ...
    gaugeChart4.setOption(option, true);
},2000);
                                   


// use configuration item and data specified to show chart
gaugeChart4.setOption(option, true), $(function() {
            function resize() {
                setTimeout(function() {
                    gaugeChart4.resize()
                }, 100)
...
var gaugeChart2 = echarts.init(document.getElementById('gauge-chart2'),'infographic');
option = null;
// specify chart configuration item and data
option = {
    tooltip : {
...
timeTicket = setInterval(function (){
    option.series[0].data[0].value = (Math.random()*100).toFixed(2) - 0;
    gaugeChart2.setOption(option, true);
},2000);
                                   

// use configuration item and data specified to show chart
gaugeChart2.setOption(option, true), $(function() {
            function resize() {
                setTimeout(function() {
                    gaugeChart2.resize()
                }, 100)
...
var barra = echarts.init(document.getElementById('bar-chart2'),'');
...
option = {
    ...
    xAxis : [
        {
            type : 'category',
            data : ['Chance','DChance','Astro','Recarca','Loteria','chanceMillonario']
        }
    ],
    yAxis : [
        {
...
option = {
    title: {
        text: '% Cumplimiento por \n Grupo de Productos año 2019',
       // subtext: 'From ExcelHome',
    ...
    yAxis : [
        {
            type : 'category',
            splitLine: {show: false},
            data : ['Chance', 'DChacne', 'Loteria', 'Recarga','Astro','Ch Mill']
        }
    ],  //$3000','$22000', '$40000','$90000','$40000
    series : [
        {
            name:'Meta',
            type:'bar',
...
// use configuration item and data specified to show chart
barra.setOption(option, true), $(function() {
    function resize() {
        setTimeout(function() {
            barra.resize()
        }, 100)
